...
class LoadingScreen extends React.Component {
    render() {
        ...
        return (React.createElement("div", { className: classnames_1.default('loading-screen', 'text-center', className) },
            React.createElement("div", { className: "loading-screen-indicator" }, (progress === 0 || progress === undefined) ? (React.createElement("i", { className: classnames_1.default('mdi mdi-loading mdi-spin', classSize), "aria-hidden": "true" })) : (React.createElement("div", { className: "progress", style: { height: '1px' } },
